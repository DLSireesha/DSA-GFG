<h2><a href="https://practice.geeksforgeeks.org/problems/implement-two-stacks-in-an-array/1?page=1&difficulty[]=-2&difficulty[]=-1&difficulty[]=0&status[]=unsolved&category[]=Stack&sortBy=submissions">Implement two stacks in an array</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Your task is to implement&nbsp;&nbsp;2 stacks in one array efficiently.</span></p>
